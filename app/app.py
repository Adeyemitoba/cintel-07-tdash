...
with ui.sidebar(title="Filter controls"):
    ...
    ui.a(
        "GitHub App",
        href="https://github.com/Adeyemitoba/cintel-07-tdash/",
        target="_blank",
    )
    ui.a(
        "GitHub Issues",
        href="https://github.com/Adeyemitoba/cintel-07-tdash/issues",
        target="_blank",
    )
    ...
    ui.a(
        "See also",
        href="https://github.com/Adeyemitoba/cintel-04-local",
        target="_blank",
    )
